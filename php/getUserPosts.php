...
$query = "SELECT a.id, a.userid, a.feeling, a.sharing, a.up, a.feeling, a.created, a.contents, a.link, a.isprivate_num, a.comment_private_num, b.urls, b.id as file, b.postid, b.filecnt
    FROM `sns_post` as a
